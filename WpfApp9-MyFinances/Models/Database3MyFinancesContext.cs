...
//using WpfApp9_MyFinances.Conventions;
//using Microsoft.EntityFrameworkCore;
...
//public class Database3MyFinancesContext : DbContextWithTriggers
//{
...
//    //private static String GetConnectionString(String databaseName) => $@"Server=(localdb)\mssqllocaldb;Database=FENRIR-PC\\SQLEXPRESS;Initial Catalog=Database3-MyFinances;Integrated Security=True;Persist Security Info=False;Pooling=False;MultipleActiveResultSets=False;Connect Timeout=60;Encrypt=False;Trusted_Connection=True;";
//    public Database3MyFinancesContext(IServiceProvider serviceProvider) : base(serviceProvider) { }
//    public Database3MyFinancesContext(IServiceProvider serviceProvider, DbContextOptions options) : base(serviceProvider, options) { }
